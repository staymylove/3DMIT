...
def VQAvisionacc(dataset,pred_data):
    ...
    for gt, pred in tqdm(zip(dataset, pred_data)):
        ...
        #print('start',res_1,res_2,res_3,pred_text, gt['gt_choices'], gt_choice)
        if len(res_1) != 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", default='ScanQA_multiplechoice')
    parser.add_argument('--answer_file', default='./ckpt/zeju-1225-1529-bs-1-74kdata-addobj-1024-llava/answers-choice/zeju-12261356-bs-1-74kdata-addobj-1024-llava/VQA_ScanQA_multiplechoice.jsonl')
    parser.add_argument('--base_data_path', default='./src/data/3D_Benchmark')
