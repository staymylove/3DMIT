...
VISION_TAGS = {
    ...
    "sov": {"image": "<Img>", "pcl": "The whole scene infomation:<pcl>"},
    "eov": {"image": "</Img>", "pcl": "</pcl>"},
    "sobj": {"image": "</Img>", "pcl": "The infomation of all the objects in scene:<obj>"}, 
    "eobj": {"image": "</Img>", "pcl": "</obj>"}
}
...
class 3DMITPEFTModel(nn.Module):
    ...
    #     #target_id=input_path[batch][61:73] # 'scnene0001_00
    #     target_id=input_path[0][61:73]
    #     object_all=torch.load(obj_path)
    #     # print(a.keys())
    #     ls=[]
